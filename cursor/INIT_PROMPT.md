...
### 2. 创建 .cursor/rules/ 规则文件

#### 2.1 创建 `.cursor/rules/doc-maintenance.mdc`

```markdown
---
description: 文档维护规则 - 修改代码时自动维护文档
globs:
  - "**/*.ts"
  - "**/*.tsx"
  - "**/*.js"
...
#### 2.2 创建 `.cursor/rules/project-structure.mdc`

根据分析结果创建，格式：

```markdown
---
description: 项目结构导航 - 帮助理解项目架构
alwaysApply: true
---
